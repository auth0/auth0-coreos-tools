...
exports.ensure_authenticated = function(ctx) {
    ...
    return function (req, res, next) {
        ...
        function check_against_secret(jwt, callback) {
            try {
        ...
        function check_authorization(jwt, callback) {
            ...
            if(!req.headers['authorization']) {
                msg = { code: 401, message: 'Unauthorized to run webtask. Must provide Authorization header.', req_id: req.req_id };
            ...
            if(jwt.payload.auth.secret)
                check_against_secret(jwt, callback);
            else
