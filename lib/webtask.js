    ...
    return function (req, res, next) {
        ...
        function validate_auth_token(auth) {
            ...
            try {
                ...
                throw new Error('Authorization secret must be base64 encoded');
            }
            ...
            if(userinfo.aud !== (auth.account.client_id || DEFAULT_AUTH0_CLIENT_ID)) throw new Error('invalid \'aud\' claim');
