...
exports.issue_token = function (options /* req, claims, kid, keyset, store_code_url, store_token, host */, callback) {
    ...
    if(new_claims.ectx) {
        ...
        if(!(new_claims.ectx.WEBTASK_JWT_SECRET && new_claims.ectx.WEBTASK_JWT_AUD) &&
            (new_claims.ectx.WEBTASK_JWT_SECRET || new_claims.ectx.WEBTASK_JWT_AUD))
            return callback(new Error('if authentication is desired, both WEBTASK_JWT_PAYLOAD & WEBTASK_JWT_AUD must be specified'));
...
exports.ensure_authenticated = function(ctx) {
    ...
    return function (req, res, next) {
        ...
        function parse_credential(credential) {
            ...
            async.series([
                ...
                function (callback) {
                    ...
                    if(ectx && ectx.WEBTASK_JWT_SECRET && ectx.WEBTASK_JWT_AUD) {
                        ...
                        try {
                            jwt.payload.user = validate_auth_token(ectx.WEBTASK_JWT_SECRET, ectx.WEBTASK_JWT_AUD);

                            delete ectx.WEBTASK_JWT_SECRET;
                            delete ectx.WEBTASK_JWT_AUD;
                        } catch(msg) {
                            ctx.logger.error({
                                req_id: req.req_id,
                                path: req.originalUrl,
        ...
        function validate_auth_token(secret, expected_aud) {
            var auth_token;
            ...
            try {
                ...
                throw { code: 403, message: 'WEBTASK_JWT_SECRET must be base64 encoded: ' + e.message, req_id: req.req_id };
            }
