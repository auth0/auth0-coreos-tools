        ...
        function validate_auth_token(auth) {
            ...
            if(auth.email) {
                if(userinfo.email_verified === false) {
                    throw new Error('This webtask can only be accessed if your email is verified');
                }
                ...
                throw new Error('The account you have attempted to use does not match this webtask\'s authorization policies.');
            } else {
                return userinfo;
            }
        }
